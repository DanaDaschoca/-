...
## Вывод: 
В ходе лабораторной работы мы перенаправили проход на сайт с http по https с порта 80 на 443. Также были сложности с тем что комнады большие, поэтому были опечатки, из-за чего возникали ошибки. У нас не было проектов с доменных именами, поэтому пришлось создать проекты, где сами прописали доменные имена. 

![тур](https://github.com/user-attachments/assets/d994dfdf-17ad-4b4a-88cf-8d8ee267e505)

## Источники: 
(В основном сложности были с ошибками, а не с самой темой лабораторной работы)

1) https://selectel.ru/blog/install-nginx/
2) https://www.reg.ru/blog/kak-zaregistrirovat-besplatnyj-domen-3-sposoba/
