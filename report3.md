...
![image](https://github.com/user-attachments/assets/53c99349-bf9c-4040-955e-135b7b400f22)
...
Вывод: у нас получилось выполнить работу через огромное количество времени, однако на другом ноутбуке, причину неполадки в на первом так и не получилось выявить. 
